...
export default {
  ...
  data() {
    return {
      ...
      g_sizes:[],
      //顶点缓冲区的数据
      vertexF32A:new Float32Array([0.0, 0.5,   -0.5, -0.5,   0.5, -0.5]),
      vertexSum:3
    }
  },
  mounted() {
    ...
    this.gltext.vertexAttrib1f(this.a_PointSize,20);
    ...
    // 画n个点
    this.gltext.drawArrays(this.gltext.POINTS, 0, this.vertexSum);
